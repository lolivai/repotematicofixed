...
#tl_admin_users = ['Stvz20', 'Mraansn', 'Javykko', 'claukm', 'rhassanlp13', 'Rassr8', 'SGD99', 'DioelHD', 'WilyElGris', 'joCanG3l'] #Poner aqui los user con acceso permanente
tl_admin_users = ['DTB86', 'MelodicSpinach', 'Krixt0', 'JMiguel07', 'KiritoOMG']
godlist = ['Krixt0','MelodicSpinach'] #Poner aqui los admin 
...
async def onmessage(bot:TelegramClient,ev: NewMessage.Event,loop,ret=False):
    ...
    if username not in tl_admin_users:
        await bot.send_message(ev.chat.id,'🚫No Tiene Acceso🚫 Contacta con @Krixt0')
        return
    ...
    if '/start' in text:
        ...
        reply += '<a href="https://t.me/+FTRBN-oxzgNkYTEx">Grupo del Bot\n\n'
        reply += '<a href="https://t.me/Krixt0">Contactar Adm</a>'
